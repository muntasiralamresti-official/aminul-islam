...
export default function FeesPage() {
  ...
  return <div className="space-y-5 pb-28 sm:space-y-6 sm:pb-8">
    ...
    <section className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm"><div className="border-b border-gray-200 p-4 sm:p-5"><div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between"><div><h2 className="text-base font-bold text-gray-900">Student-wise Fee Dashboard</h2><p className="mt-1 text-xs text-gray-500">{hasStudentFilters ? `${filteredStudents.length} matching students · ${totalActiveStudents} active` : `${totalActiveStudents} active students`} · {selectedMonth} {selectedYear}</p>
      {hasStudentFilters && (

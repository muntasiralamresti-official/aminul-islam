      ...
      >
        ...
        <div className="relative flex-1 flex flex-col max-w-[280px] w-full pt-5 pb-4 bg-white shadow-xl h-full transition-transform duration-300">
          ...
          <div className="flex-shrink-0 flex items-center px-6">
            ...
            <span className="ml-3 text-xl font-bold text-gray-900 truncate">
              {centerName}
            </span>
          </div>
            ...
            <div className="flex-shrink-0 w-full group block">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-red-600 p-2 bg-gray-50 rounded-full hover:bg-red-50 transition-colors"
                >
      ...
      <div className="lg:hidden fixed bottom-0 w-full bg-white border-t border-gray-200 flex justify-around items-center z-40 pb-2 pt-1 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
        {[
          ...
          <button
            ...
            className={clsx(
              pathname === item.href && !item.isMenu
                ? "text-blue-600"
          ...
          >
            <item.icon
              className={clsx(
                "h-6 w-6 mb-1",
                pathname === item.href && !item.isMenu ? "text-blue-600" : "",
              )}
            />
            {item.name}
          </button>

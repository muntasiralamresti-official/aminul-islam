...
export default function EditStudentPage({ params }) {
  ...
  const [formData, setFormData] = useState({ name: '', rollNumber: '', phone: '', guardianPhone: '', address: '', classLevel: '', batch: '', monthlyFee: '', photo: '', photoUrl: '', status: 'active' });

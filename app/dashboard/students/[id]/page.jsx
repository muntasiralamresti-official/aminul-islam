...
import { ArrowLeft, Edit, Eye, Trash2, Phone, Mail, MapPin, CalendarDays, GraduationCap, ShieldCheck, UsersRound, Clock3 } from "lucide-react";
...
export default function StudentProfilePage({ params }) {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl pb-8">
      ...
      <section className="overflow-hidden rounded-[26px] border border-slate-200/90 bg-white shadow-[0_10px_35px_rgba(15,23,42,0.09)]">
      ...
      <section className="mt-4 rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm sm:mt-5 sm:p-5">

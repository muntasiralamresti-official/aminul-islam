...
function StudentsContent() {
  ...
  const handleSearch = (value) => { setSearchQuery(value); setCurrentPage(1); updateUrl(1, value); };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (students.length === 1 && currentPage > 1) handlePageChange(currentPage - 1); else fetchStudents();

...
async function run() {
  const directUri = process.env.MONGODB_URI.replace(
    ...
    'mongodb://whoismuntasir04_db_user:%40muntasir04@ac-vgtnowu-shard-00-00.xrpvucx.mongodb.net:27017,ac-vgtnowu-shard-00-01.xrpvucx.mongodb.net:27017,ac-vgtnowu-shard-00-02.xrpvucx.mongodb.net:27017/?ssl=true&replicaSet=atlas-vgtnowu-shard-0&authSource=admin&retryWrites=true&w=majority'
  );
